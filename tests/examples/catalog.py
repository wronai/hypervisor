...
RUN_SH_EXAMPLES: tuple[ExampleSpec, ...] = (
    ExampleSpec("04", "nl2a_weather_map", "run_sh", "examples/04_nl2a_weather_map/run.sh", timeout_s=180),
    ...
    ExampleSpec("11", "playwright_browser", "run_sh", "examples/11_playwright_browser/run.sh", ("playwright",), 180),
    ...
    ExampleSpec("13nl", "nl2uri_multi_uri_graph", "run_sh", "examples/13_nl2uri_multi_uri_graph/run.sh"),
    ExampleSpec("14wf", "workflow_executor_mock", "run_sh", "examples/14_workflow_executor_mock/run.sh"),
